...
var filterText = filter = require("./filter.json");
...
socket.on("item", function(item) {
    // console.log("\n" + JSON.stringify(item));
    if( item.shop.verified !== "GONE" ){
        console.log('\u0007');
        console.log("================================================")
        console.log(item.info.fullName);
        console.log(item.shop.verified);
        console.log(item.shop.amount + " " + item.shop.currency + "(" + item.shop.saleType + ")");
        console.log(item.shop.defaultMessage);
        console.log("================================================");
    }
});
